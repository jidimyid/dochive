...
<body style="background-color: #2e2e2e;">
    ...
    <div class="btn-group-vertical text-white" role="group" aria-label="Vertical button group">
    <button type="button" class="btn btn-dark"><a href="https://web.facebook.com/yazid.skak.3">Facebook</a></button>
    <button type="button" class="btn btn-dark"><a href="https://www.instagram.com/jidiabd/">Instagram</a></button>
    <button type="button" class="btn btn-dark"><a href="https://twitter.com/jidimyid">Twitter</a></button>
    </div>
